...
export const EventCompanyFeaturesPage = ({ onGetStarted }: EventCompanyFeaturesPageProps) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-indigo-25 to-blue-50 relative overflow-hidden"
      ...
      {/* Header */}
      <header className="relative z-10 bg-white/95 backdrop-blur-xl border-b border-purple-200/50 shadow-lg sticky top-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-3 md:py-4">
            <div className="flex items-center space-x-4">
              <Link to="/">
                <Button variant="outline" size="sm" className="border-2 border-purple-200 hover:border-purple-400 hover:bg-purple-50 text-slate-700 rounded-2xl smooth-transition">
            ...
            <Button 
              ...
              size="sm"
              className="bg-gradient-to-r from-purple-400 to-indigo-500 hover:from-purple-500 hover:to-indigo-600 text-white rounded-2xl smooth-transition"
            >
              Get Started
            </Button>
          </div>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="text-center mb-12 md:mb-16 animate-fade-in-up">
          <div className="w-16 h-16 md:w-20 md:h-20 mx-auto mb-4 md:mb-6 bg-gradient-to-br from-purple-400 to-indigo-500 rounded-3xl flex items-center justify-center shadow-xl smooth-transition hover:scale-105">
            <Building2 className="h-8 w-8 md:h-10 md:w-10 text-white" />
          </div>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent mb-4 md:mb-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 md:gap-8 text-sm text-slate-600">
            ...
            <div className="flex items-center space-x-2">
              <Star className="h-4 w-4 md:h-5 md:w-5 text-purple-500 fill-current" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 mb-12 md:mb-16">
          {features.map((feature, index) => (
            <Card key={index} className="bg-white/95 backdrop-blur-xl border-2 border-purple-200/30 shadow-lg rounded-3xl smooth-transition hover:shadow-xl hover:-translate-y-1 animate-stagger">
              <CardHeader className="pb-4">
                <div className="flex items-start space-x-4 mb-4">
                  <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-purple-400 to-indigo-500 rounded-2xl flex items-center justify-center flex-shrink-0 smooth-transition hover:scale-105">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {feature.benefits.map((benefit, benefitIndex) => (
                    <div key={benefitIndex} className="flex items-center space-x-2">
                      <Check className="h-3 w-3 md:h-4 md:w-4 text-purple-500 flex-shrink-0" />
        ...
        {/* Call to Action */}
        <div className="text-center bg-white/95 backdrop-blur-xl border-2 border-purple-200/50 shadow-lg rounded-3xl p-8 md:p-12 animate-fade-in-up">
          <h2 className="text-2xl md:text-3xl font-serif font-bold bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent mb-4 md:mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
            <Button 
              onClick={onGetStarted}
              size="lg" 
              className="bg-gradient-to-r from-purple-400 to-indigo-500 hover:from-purple-500 hover:to-indigo-600 text-white rounded-2xl text-lg md:text-xl px-8 md:px-12 py-4 md:py-6 w-full sm:w-auto"
            >
              <Building2 className="mr-3 h-5 w-5 md:h-6 md:w-6" />
              Start Free Trial
            </Button>
            <Button 
              variant="outline"
              size="lg" 
              className="border-2 border-purple-300 hover:border-purple-500 hover:bg-purple-50 text-purple-700 rounded-2xl text-lg md:text-xl px-8 md:px-12 py-4 md:py-6 smooth-transition w-full sm:w-auto"
            >
              Schedule Demo
            </Button>
          </div>
