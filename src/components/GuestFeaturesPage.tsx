    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-25 via-blush-50 to-lavender-50 relative overflow-hidden"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-rose-400 to-pink-500 rounded-3xl flex items-center justify-center romantic-shadow">
            <Heart className="h-10 w-10 text-white" />
          </div>
          <h1 className="text-4xl md:text-5xl font-serif font-bold elegant-text-gradient mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {features.map((feature, index) => (
            <Card key={index} className="bg-white/95 backdrop-blur-xl border-2 border-rose-200/30 romantic-shadow rounded-3xl hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
        ...
        {/* Call to Action */}
        <div className="text-center bg-white/95 backdrop-blur-xl border-2 border-rose-200/50 romantic-shadow rounded-3xl p-12">
          <h2 className="text-3xl font-serif font-bold elegant-text-gradient mb-6">
