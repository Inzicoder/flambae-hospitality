...
export const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    PARTICIPANTS: {
      ...
      GET_BY_ID: (participantId: string) =>
        `/event-participants/${participantId}`,
      GET_BY_EVENT: (eventId: string) =>
        `/event-participants?eventId=${eventId}`,
      UPDATE: (eventId: string, participantId: string) =>
        `/event-participants/${eventId}/${participantId}`,
      DELETE: (id: string) => `/event-participants/${id}`,
      UPLOAD_DOCUMENT: (participantId: string) =>
        `/event-participants/document/${participantId}`,
    },
    // Help desk endpoints
    HELP_DESK: {
      LIST: "/help-desk",
      ...
      GET_BY_ID: (eventId: string, ticketId: string) =>
        `/help-desk/${eventId}/${ticketId}`,
      UPDATE: (eventId: string, ticketId: string) =>
        `/help-desk/${eventId}/${ticketId}`,
